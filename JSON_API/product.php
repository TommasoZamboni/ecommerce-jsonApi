...
class Product
{
    ...
    {
        $pdo = self::Connect();
        $stmt = $pdo->prepare("INSERT INTO  tommaso_zamboni_ecommerce.products (nome,marca,prezzo) VALUES (:nome,:marca,:prezzo)");
    ...
    {
        $pdo = self::Connect();
        $stmt = $pdo->prepare("UPDATE  tommaso_zamboni_ecommerce.products SET nome = :nome, marca = :marca, prezzo = :prezzo WHERE id = :id");
    ...
    public function Delete()
    {
        ...
        $id = $this->getId();
        $pdo = self::Connect();
        $stmt = $pdo->prepare("DELETE FROM  tommaso_zamboni_ecommerce.products WHERE id = :id");
    ...
    {
        return DbManager::Connect("tommaso_zamboni_ecommerce");
    }
